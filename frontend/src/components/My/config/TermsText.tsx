    ...
    <TermsContainer>
      <div className="section">
        ...
        <Text $typography="t12" color="grey2" style={{ lineHeight: '19px' }}>
          본 이용약관은 “한품”(이하 "사이트")의 서비스의 이용조건과 운영에 관한
          제반 사항 규정을 목적으로 합니다.
        </Text>
      </div>
      ...
      <div className="section">
        ...
        <Text $typography="t12" color="grey2" style={{ lineHeight: '19px' }}>
          ...
          지지 않습니다. 운영자는 회원이 미풍양속에 저해되거나 국가안보에
          위배되는 게시물 등 위법한 게시물을 등록 · 배포할 경우 관련 기관의
      ...
      <div className="section">
        ...
        <ol>
          <li>
            ...
            및 운영정책 등 사이트가 공지하는 사항 및 관계 법령을 준수하여야
            하며, 기타 사이트의 업무에 방해가 되는 행위, 사이트의 명예를
            손상하는 행위를 해서는 안 됩니다.
          </li>
          <li>
      ...
      <div className="section">
        ...
        <ol>
          ...
          <li>
            ...
            <div className="second-text">
              - 공공질서 및 미풍양속에 위반되는 내용을 유포하거나 링크 시키는
              경우
            </div>
            <div className="second-text">
